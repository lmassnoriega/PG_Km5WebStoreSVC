...
public class AlbumsApiServiceImpl extends AlbumsApiService {
    ...
    @Override
    public Response albumsGet(SecurityContext securityContext)
    ...
    @Override
    public Response albumsGetById(Integer id, SecurityContext securityContext)
    throws NotFoundException {
        ArrayList<Album> list = loadAlbums();
        Album ret = null;
